...
* AI$<$RA
    ...
    * 普通に尋ねると、安易な一般化が激しく要所を外しがち
      ...
      「ヤギを4頭あげるともっと貧しくなる理由.mp4」
    
      > 「極貧層向けのマイクロファイナンスでは資産(ヤギ4頭)、ノウハウ(コーチング)、セーフティネット(生活費支援)を組み合わせる以外の近道はありませんでした」「バンドウィドス・タックスという言葉を聞いたことがあるでしょうか」「おおきはば(???)への課税ですか」「明日のご飯をどうしようという強烈な不安に直面しているとき、脳の認知的余裕、つまり、おおきはばの殆どを奪われてしまうのです」「分かります、私も仕事で追い詰められているときは一年後の長期プランなんて考えられませんもの」
        
      >「ヤギを4頭あげた方が全部載せのGUP参加者よりも貧しくなったのですね」
        
      さまざまな支援を与えられたアームと比較して部分的支援の方が低いのは当たり前
      :::
      :::::
...
* NotebookLMで極貧層向けマイクロファイナンスについて50論文pdfから文献サーベイさせた
    * 通常のMFは全く駄目で、大型家畜移転+トレーニングをスケールアップする方法ばかりを論じた
    * 影響力のある研究者(Abijit Banerjee)の特定論文の主張
