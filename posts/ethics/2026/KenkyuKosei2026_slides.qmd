...
# 「誰が」「何をやって」「何が分かった」=知識、を検証可能な状態で蓄積する。{background-color="#010638"}


----

## なぜ知識を検証可能な状態にしておくか...研究者目線で{background-color="#010638"}
...
* でも、[共著者リスクも付いてくる](https://pmc.ncbi.nlm.nih.gov/articles/PMC2541639/)&larr; Asad IslamのFF疑惑
* パワハラ・圧力による盗用ならFFP...利益配分&larr;研究倫理
:::
:::::
::::::::::
...
* 大物追従志向はないか
    * 例: 早期児童発達介入は非認知能力を高める、プライミング、最貧層貸付にはトレーニングが必須
...
:::::::::: {.columns}
<DarkGray>「誰が」</DarkGray><span style="color:white;">「何をやって」</span><DarkGray>「何が分かったか」を検証可能な状態で蓄積する</DarkGray>
...
::::: {.column width = "68%"}
::: {.incremental}
* <DarkGray>識者によって内容が異なるので幾つか列記  </DarkGray>
* <DarkGray>GAは贈収(賄)双方に便益あり、なくなりにくい、でも、パワハラによる盗用ならばFFP、[著者責任も付いてくる](https://pmc.ncbi.nlm.nih.gov/articles/PMC2541639/)&larr; Asad IsamのFF疑惑   </DarkGray>
* 再現性がない &rArr; 成果が疑問視 &rArr; 発見が知識にならない
* $P$-hacking: E.g.,  望んだ結果が出るまで推計を試行し、その結果のみ提示すること ![https://xkcd.com/882/](AcneJellybeans.jpg){height=30 .lightbox} 
* HARKing: 結果を見て仮説を決めること[hypothesizing after the results are known](https://brokenscience.org/harking-hypothesizing-after-the-results-are-known/) ![Dirk-Jan Hoek, CC-BY](Harking.jpg){height=30 .lightbox} ([paper](https://dl.acm.org/doi/10.1145/3360311)) ([video](https://www.youtube.com/watch?v=mzU_Fq1wQ6k))
* <DarkGray>刊行された論文を翻訳して投稿してはいけません ([International Committee of Medical Journal Editors](https://www.icmje.org/recommendations/browse/publishing-and-editorial-issues/overlapping-publications.html#:~:text=Authors%20should%20not%20submit%20the%20same%20manuscript%2C%20in%20the%20same%20or%20different%20languages%2C%20simultaneously%20to%20more%20than%20one%20journal.))</DarkGray>
:::
:::::
::::::::::
