...
::::{.incremental}
* 人間が検証するならAI使う必要あり?
* 何に使うか: 最終成果に近い作業まで使う人もいる
  * 異分野・新規課題の展望
  * コード(debugging, refactoring)
  * 数式の展開、[証明の論理検証](www.refine.ink)
