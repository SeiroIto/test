...
<!-- preamble start -->
    ...
    <script>
      ...
      function styleCell_c27fr0r3t2erxclhojva(i, j, css_id) {
          var table = document.getElementById("tinytable_c27fr0r3t2erxclhojva");
      ...
      function spanCell_c27fr0r3t2erxclhojva(i, j, rowspan, colspan) {
        var table = document.getElementById("tinytable_c27fr0r3t2erxclhojva");
      ...
      window.addEventListener('load', function () {
          ...
          { positions: [ { i: 7, j: 1 },  ], css_id: 'tinytable_css_ztshad1eqqgkbplzvlsk',}, 
          { positions: [ { i: 1, j: 0 }, { i: 2, j: 0 }, { i: 3, j: 0 }, { i: 4, j: 0 }, { i: 5, j: 0 }, { i: 6, j: 0 },  ], css_id: 'tinytable_css_rt6uybwlpxhxkpndvems',}, 
          { positions: [ { i: 7, j: 0 },  ], css_id: 'tinytable_css_pnukli098nijzyry9sj2',}, 
          { positions: [ { i: 0, j: 1 },  ], css_id: 'tinytable_css_fybskgq9gtdh4r7ejl0i',}, 
          { positions: [ { i: 1, j: 1 }, { i: 2, j: 1 }, { i: 3, j: 1 }, { i: 4, j: 1 }, { i: 5, j: 1 }, { i: 6, j: 1 },  ], css_id: 'tinytable_css_7nghqbcgwhtyvm0wxhkl',}, 
          { positions: [ { i: 0, j: 0 },  ], css_id: 'tinytable_css_32ei4fm9tzwz0sbv4fyk',}, 
          ];

          // Loop over the arrays to style the cells
          cellsToStyle.forEach(function (group) {
              group.positions.forEach(function (cell) {
                  styleCell_c27fr0r3t2erxclhojva(cell.i, cell.j, group.css_id);
              });
          });
      });
    </script>
    ...
    <style>
      ...
      .table td.tinytable_css_ztshad1eqqgkbplzvlsk, .table th.tinytable_css_ztshad1eqqgkbplzvlsk { text-align: left; border-bottom: solid #d3d8dc 0.1em; width: 35%; }
      .table td.tinytable_css_rt6uybwlpxhxkpndvems, .table th.tinytable_css_rt6uybwlpxhxkpndvems { text-align: right; width: 65%; }
      .table td.tinytable_css_pnukli098nijzyry9sj2, .table th.tinytable_css_pnukli098nijzyry9sj2 { text-align: right; border-bottom: solid #d3d8dc 0.1em; width: 65%; }
      .table td.tinytable_css_fybskgq9gtdh4r7ejl0i, .table th.tinytable_css_fybskgq9gtdh4r7ejl0i { text-align: left; border-top: solid #d3d8dc 0.1em; border-bottom: solid #d3d8dc 0.05em; width: 35%; }
      .table td.tinytable_css_7nghqbcgwhtyvm0wxhkl, .table th.tinytable_css_7nghqbcgwhtyvm0wxhkl { text-align: left; width: 35%; }
      .table td.tinytable_css_32ei4fm9tzwz0sbv4fyk, .table th.tinytable_css_32ei4fm9tzwz0sbv4fyk { text-align: right; border-top: solid #d3d8dc 0.1em; border-bottom: solid #d3d8dc 0.05em; width: 65%; }
    </style>
    <div class="container">
      <table class="table table-borderless" id="tinytable_c27fr0r3t2erxclhojva" style="table-layout: fixed; width: 100% !important; margin-left: auto; margin-right: auto;" data-quarto-disable-processing='true'>
        <thead>
